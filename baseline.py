...
from .attention import se_block, cbam_block, eca_block, CIFAM_Block

attention_blocks = [se_block, cbam_block, eca_block, CIFAM_Block]


class CenterNet_Resnet50(nn.Module):
    def __init__(self, num_classes = 20, pretrained = False, phi = 4):
        ...
        if phi >= 1 and phi <= 3:
            self.feat_attention = attention_blocks[phi - 1](2048) 
